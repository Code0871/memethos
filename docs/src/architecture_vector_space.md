...
In the Chains vector space, points store shared data about the chain and a set of all moment IDs (in [UUID v7](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_7_(timestamp_and_random)) format)
...
>But for now, I don't care about 3D visualization